...
public class WaitPingLunFragment extends BaseFragment {
    ...
    protected View initView() {
        View view=View.inflate(mContext, R.layout.activity_wait_ping_lun_fragment,null);
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        if (mHomeFragmentBean.getCode()==200){
                            data = mHomeFragmentBean.getData();
                                allDingDanAdapter = new AllDingDanAdapter(R.layout.mine_waitpinglun_item, data);
...
//                            Toast.makeText(mContext, "暂时没有订单", Toast.LENGTH_SHORT).show();
    ...
    class AllDingDanAdapter extends BaseQuickAdapter<DingDanBean.DataBean, BaseViewHolder> {
        ...
        protected void convert(BaseViewHolder helper, final DingDanBean.DataBean item) {
            ...
            TextView tv_dingdanxq = helper.getView(R.id.tv_dingdanxq);
            ...
            tv_dingdanxq.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(mContext,DingDanXQActivity.class);
                    intent.putExtra("","");
