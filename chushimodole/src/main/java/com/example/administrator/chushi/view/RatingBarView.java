...
import com.example.administrator.chushi.exception.IllegalNumberException;
...
public class RatingBarView extends LinearLayout implements View.OnClickListener {
    ...
    private static final int DEFAULT_NORMAL_ICON_RES_ID = R.drawable.xingxing2;//默认图片资源id
    private static final int DEFAULT_SELECTED_ICON_RES_ID = R.drawable.xingxing1;//选中图片资源id
