...
public class YiGuoQiFragment extends BaseFragment {
    ...
    private List<YouHuiJuanBean.DataBean.WuxiaoBean> wuxiao;

    @Override
    protected View initView() {
        View view=View.inflate(mContext, R.layout.activity_yiguoqi_fragment,null);
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        if (mHomeFragmentBean.getCode()==200){
                            wuxiao = mHomeFragmentBean.getData().getWuxiao();
                            initAdapter();
    ...
    private void initAdapter() {
            allDingDanItemAdapter = new AllDingDanItemAdapter(R.layout.mine_yiguoqi_item, wuxiao);
    ...
    class AllDingDanItemAdapter extends BaseQuickAdapter<YouHuiJuanBean.DataBean.WuxiaoBean, BaseViewHolder> {

        public AllDingDanItemAdapter(@LayoutRes int layoutResId, @Nullable List<YouHuiJuanBean.DataBean.WuxiaoBean> data) {
            super(layoutResId, data);
        }

        @Override
        protected void convert(BaseViewHolder helper, YouHuiJuanBean.DataBean.WuxiaoBean item) {
